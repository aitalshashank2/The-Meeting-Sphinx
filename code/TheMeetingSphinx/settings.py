"""
Django settings for TheMeetingSphinx project.
...
CORS_ORIGIN_WHITELIST = CONFIG_VARS['CORS_ORIGIN_WHITELIST']
...
ROOT_URLCONF = 'TheMeetingSphinx.urls'
...
WSGI_APPLICATION = 'TheMeetingSphinx.wsgi.application'
